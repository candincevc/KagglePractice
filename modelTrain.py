...
def getSub(X_test,models,test_id,X_train,y_train):
...
def main():
    ...
    stacked_averaged_models=StackingAveragedModels(base_models=(ENet,lasso,KRR),meta_model=GBoost)       
    models=(stacked_averaged_models,lasso,ENet,KRR,GBoost,averaged_models)
   
    # select model
    model_final =selectModels(X_train,y_train,models)
    getSub(X_test,model_final,test_id,X_train,y_train)
